 ...
 */
public class MySSABuilder2 extends AbstractIntStackMachine {

  public static MySSABuilder2 make(IBytecodeMethod method, SSACFG cfg, ShrikeCFG scfg, SSAInstruction[] instructions,
    ...
    return new MySSABuilder2(method, cfg, scfg, instructions, symbolTable, buildLocalMap, piNodePolicy);
  }
  ...
  private MySSABuilder2(IBytecodeMethod method, SSACFG cfg, ShrikeCFG scfg, SSAInstruction[] instructions, SymbolTable symbolTable,
  ...
  private static class SSA2LocalMap implements com.ibm.wala.ssa.IR.SSA2LocalMap {
     ...
     */
    private void finishLocalMap(MySSABuilder2 builder) {
