 ...
 */
public class MySSABuilder extends AbstractIntStackMachine {

  public static MySSABuilder make(IBytecodeMethod method, SSACFG cfg, ShrikeCFG scfg, SSAInstruction[] instructions,
    ...
    return new MySSABuilder(method, cfg, scfg, instructions, symbolTable, buildLocalMap, piNodePolicy);
  }
  ...
  private MySSABuilder(IBytecodeMethod method, SSACFG cfg, ShrikeCFG scfg, SSAInstruction[] instructions, SymbolTable symbolTable,
  ...
  private static class SSA2LocalMap implements com.ibm.wala.ssa.IR.SSA2LocalMap {
     ...
     */
    private void finishLocalMap(MySSABuilder builder) {
