...
public class SlicingTask implements ITask {
    ...
    public void forwardSlice(List<NormalStatement> statements, SlicingContext context) throws IllegalArgumentException, CancelException {
		forwardSliceWithOptions(statements, context, setData(context), setControl(context));
    }
    ...
    public void backwardSlice(List<NormalStatement> statements, SlicingContext context) throws IllegalArgumentException, CancelException {
		backWardSliceWithOptions(statements, context, setData(context), setControl(context));
    ...
    public  DataDependenceOptions setData(SlicingContext context) {
    		DataDependenceOptions d= DataDependenceOptions.NONE;
    		
    		switch(context.optionsData) {
    		case FULL:
    			d = DataDependenceOptions.FULL;
    			break;
    		case NO_BASE_PTRS:
    			d = DataDependenceOptions.NO_BASE_PTRS;
    			break;
    		case NO_BASE_NO_HEAP:
    			d = DataDependenceOptions.NO_BASE_NO_HEAP;
    			break;
    		case NO_HEAP:
    			d = DataDependenceOptions.NO_HEAP;
    			break;
    		case NONE:
    			d = DataDependenceOptions.NONE;
    			break;
    		case REFLECTION:
    			d = DataDependenceOptions.REFLECTION;
    			break;
    		}
    ...
    public ControlDependenceOptions setControl(SlicingContext context) {
    		ControlDependenceOptions c =  ControlDependenceOptions.NONE;
    		
    		switch(context.optionsCD) {
    		case FULL:
    			c = ControlDependenceOptions.FULL;
    			break;
    		case NONE: 
    			c = ControlDependenceOptions.NONE;
    		}
    		return c;
    }
}